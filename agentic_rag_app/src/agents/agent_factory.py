...
class AgentFactory:
    ...
    def create_manager_system(
        self,
        specialized_agents: List[str] = None,
        vector_store = None,
        **kwargs
    ) -> ManagerAgent:
        """
    ...
    def get_factory_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_types_used": len(set(info["type"] for info in self.agent_registry.values())),
...
def create_manager_system(vector_store=None, config: Dict[str, Any] = None) -> ManagerAgent:
    """
