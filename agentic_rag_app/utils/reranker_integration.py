...
class RerankerProcessor:
    ...
    def _rerank_with_rerankers(
        ...
        try:
            ...
            logger.error(f"Error with rerankers library: {e}")
            raise
    ...
    def _rerank_with_cross_encoder(
        ...
        try:
            ...
            logger.error(f"Error with cross-encoder: {e}")
            raise
...
def get_qwen_reranker() -> Optional[RerankerProcessor]:
    """
    ...
    for model_name in qwen_models:
        try:
            ...
            if reranker.is_available():
                logger.info(f"Successfully initialized Qwen reranker: {model_name}")
                return reranker
        except Exception as e:
