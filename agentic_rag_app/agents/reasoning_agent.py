"""Reasoning agent implementation for complex analytical tasks.

This module provides the ReasoningAgent class that uses advanced reasoning
capabilities for step-by-step problem solving and analysis.
"""
...
class ReasoningAgent:
    ...
    def __init__(self, model_name: str = "qwen3-32b") -> None:
        """Initialize the reasoning agent with specified model.
    ...
    def think(self, query: str, enable_thinking: bool = True) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception("Error in reasoning: %s", e)
            return {
                "query": query,
                "thinking_enabled": enable_thinking,
                "thinking_steps": None,
                "final_answer": f"Error occurred during reasoning: {e!s}",
                "full_response": None,
                "model_used": self.model_name,
            }
...
"""
    ...
    def _parse_response(self, response: str) -> tuple[str | None, str]:
...
def get_reasoning_agent(model_name: str = "qwen3-32b") -> ReasoningAgent:
    """Get or create a global reasoning agent instance.

    Args:
        model_name: Name of the language model to use.

    Returns:
        The ReasoningAgent singleton instance.
    """
